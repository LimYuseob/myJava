...
//		System.out.println(d1.intstanceCount);
		...
		//SQL 을 날리는 작업을 할건데, 이것도 pattern 이 정해져 있음.
		//2개의 객체(interface) 를 주로 사용하는데, Statement, PreparedStatement
		//임..위 두개의 객체는 Connection 객체의 메서드를 호출하면 자동 리턴됨
		//찾아보세요.
		try {
			...
			String sql = "Insert into Users(USERID,USERNAME,USERPASSWORD,"
					...
					+ "('Ssam','노재현','1111',30,'test@test.com')";
