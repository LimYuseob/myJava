...
public class JmenuEx extends JFrame {
	...
	ImageIcon im = new ImageIcon("cup-2.png");
	JMenuItem fopen = new JMenuItem(im);
	
	ImageIcon im1 = new ImageIcon("Icon.png");
	JMenuItem fexit = new JMenuItem(im1);
	
	JMenu edit = new JMenu("편진잡");
	...
	JCheckBoxMenuItem ecgreedn = new JCheckBoxMenuItem("Green");
	...
	private void init() {
		...
		//라디오메뉴아이템은 토글로 만들어야 하기 때문에
		//ButtonGroup 으로 묶어줍니다.
		bg.add(es10);
		bg.add(es20);
		bg.add(es30);
