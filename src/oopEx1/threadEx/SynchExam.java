 ...
 * lock 을 걸어서 다른 쓰래드가 접근을 할 수 없도록 한다. 점유한 쓰래드가 작업을 다 마칠떄까지
 * 다른 쓰래드는 대기 영역에 머물게 되고, lock 을 해체하는 순간 객체에 접근 하여 run() 을 수행
 * 한다.
 * 
 ...
 * 두번째 synchronized(공유객체명){동기화가 필요한 로직 구현} 으로 한다.
 */
