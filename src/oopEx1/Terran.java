...
public abstract class Terran extends Object{
	...
	/*
	 * final 키워드 : fianl 은 클래스, 멤버필드, 메서드, 메서드 파라미터, 메서드 바디
	 * 내 어디에도 사용될 수 있습니다.
	 * 
	 * 이름에서도 알수 있듯이, final 키워드 뭔가를 고정 시키는 역활을 합니다.
	 ...
	 */
	//static final 필드는 반드시 초기화 해야합니다.
//	final static int allUnit_MIN_HP = 0;
//	final int Marine_MAX_HP = 50;
//	final int Medic_MAX_HP = 60;
//	final int FireBet_MAX_HP = 70;
//	final int Ghost_MAX_HP = 80;
//	
	
/*
 * 자바추상화(Abstraction) : 자바 추상화란 특정 메서드가 자신을 위한것이 아닌, 오로지 상속
 * 만을 위한 것으로 생각 될 때, 해당 메서드를 추상화 할 수 있습니다.
 ...
 * 없습니다.
 * 
 * 하지만, 상속 및 다형성등은 그대로 유지 할 수 있습니다.
 * 
 ...
 */
	...
	//추상메서드는 abstract 키워드와 함게 선언만 할수있습니다.
