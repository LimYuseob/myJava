 ...
 * 예외 타입을 알아 봅니다, 또한 콜 스택에서 예외가 어떻게 전파 되어지는지도 확인합니다.
 * 
 * 예외의 최고 대빵 클래스는 Exception 이고 이 클래스는 부모(Throable) 로부터 모든걸 상속
 * 받고 있습니다. 해서 최고 클래스를 Exception 으로 생각하시면 됩니다.
 * 
 * 또 Exception 하위에는 각 예외내용별로 정의 되어 있는데, 이중 RuntimeException
...
public class ExceptionEx1 {
	...
	static void c() {
		String input = JOptionPane.showInputDialog("나눌 숫자값 입력");
